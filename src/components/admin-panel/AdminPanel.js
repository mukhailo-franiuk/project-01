...
export default function AdminPanel() {
    document.title = `Адмін панель - Store App`;
    const links = [
        { name: "Основна інформація", path: "" },
        { name: "Продукти", path: "products" },
        { name: "Основні категорії", path: "categories" },
        { name: "Під категорії", path: "sub-categories" },
        { name: "Повідомлення", path: "messages" }
    ]
    return (
        <div className="fixed w-full antialiased scroll-m-1 bg-gray-50">
            <nav className="bg-orange-500 border-b border-gray-200 px-4 py-2.5 fixed left-0 right-0 top-0 z-50">
                <div className="flex flex-wrap justify-between items-center">
                    <div className="flex justify-start items-center">
                        <button
                            className="p-2 mr-2 text-white rounded-lg cursor-pointer md:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100  focus:ring-2 focus:ring-gray-100 "
                        >
                            <svg
                                aria-hidden="true"
                                class="w-6 h-6"
                        ...
                        <Link to={``} class="flex items-center justify-between mr-4">
                        ...
                        <form method="GET" className="hidden md:block md:pl-2">
                            ...
                            <div className="relative lg:w-96 md:w-96">
                                <div
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        >
                            <div
                                className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50"
                            >
                                Notifications
                            </div>
                            <div>
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        ...
                                        />
                                        <div
                                            className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-primary-700"
                                        >
                                            <svg
                                                aria-hidden="true"
                                    ...
                                    <div className="pl-3 w-full">
                                        <div
                                            className="text-gray-500 font-normal text-sm mb-1.5"
                                        >
                                            New message from
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        ...
                                        />
                                        <div
                                            className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-red-600 rounded-full border border-white"
                                        >
                                            <svg
                                                aria-hidden="true"
                                                className="w-3 h-3 text-white"
                                ...
                                >
                                    <div className="flex-shrink-0">
                                        ...
                                        />
                                        <div
                                            className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-green-400 rounded-full border border-white"
                                        >
                                            <svg
                                                aria-hidden="true"
                                                className="w-3 h-3 text-white"
                                ...
                                <Link
                                    to={``}
                                    claclassNamess="flex py-3 px-4 hover:bg-gray-100 "
                                >
                                    <div className="flex-shrink-0">
                                        <img
                                            className="w-11 h-11 rounded-full"
                                        ...
                                        />
                                        <div
                                            className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-purple-500 rounded-full border border-white"
                                        >
                                            <svg
                                                aria-hidden="true"
                                                className="w-3 h-3 text-white"
            ...
            >
                <div class="overflow-y-auto py-5 px-3 h-full bg-orange-500">
                    <form method="GET" class="md:hidden mb-2">
                        <label htmlFor="sidebar-search" class="sr-only">Search</label>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link
                                to={``}
                                className="flex items-center p-2 text-base font-medium text-white rounded-lg hover:text-gray-900 hover:bg-gray-100 group"
                            >
                                <svg
                                    aria-hidden="true"
                                    className="w-6 h-6 text-white transition duration-75 400 group-hover:text-gray-900 "
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                                ...
                                <span className="ml-3">Iнформація</span>
                            </Link>
                        </li>
                        <li>
                            <button
                                type="button"
                                className="flex items-center p-2 w-full text-base font-medium text-white hover:text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 "
                            ...
                            <ul class=" py-2 space-y-2">
                                <li>
                                    <Link
                                        to={``}
                                        className="flex items-center p-2 pl-11 w-full text-base font-medium text-white hover:text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100"
                                    >Settings</Link>
                                </li>
                                <li>
                                    <Link
