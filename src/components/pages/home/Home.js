...
import { NewProductList } from "./NewProductsComponent";
const Home = () => {
    ...
    return (
        <div className="w-full flex flex-col">
            ...
            <section className="w-full lg:my-5 my-2 flex flex-col">
                <div className="w-full my-2 flex flex-col justify-center items-center">
                    <h2 className="text-md lg:text-3xl py-2">New products</h2>
                    <p className="py-2">New products are waiting for you</p>
                </div>
                <section class="py-8 antialiased bg-gray-900 md:py-12">
                    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                        <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                            <div>
                                <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">New products</h2>
                            </div>
                            <div class="flex items-center space-x-4">

                                <Link to={`/`} className="flex w-full items-center justify-center px-3 py-2 text-sm font-medium text-white sm:w-auto">
                                    New
            ...
            <section className="w-full lg:my-5 my-2 flex flex-col">
                <div className="w-full my-2 flex flex-col justify-center items-center">
                    <h2 className="text-md lg:text-3xl py-2">Most popular</h2>
                    <p className="py-2">Most popular products</p>
                </div>
                <section class="py-8 antialiased bg-gray-900 md:py-12">
                    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                        <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                            <div>
                                <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Most popular</h2>
                            </div>
                            <div class="flex items-center space-x-4">
            ...
            {/* Question section */}
            <section className="w-full lg:my-5 my-2 flex flex-col">
                <div className="w-full my-2 flex flex-col justify-center items-center border-b-2 border-gray-900">
                    <h2 className="text-md lg:text-3xl py-2">Frequently asked questions</h2>
                </div>

                <div class="rounded-base border border-default overflow-hidden shadow-xs mx-auto">
