...
const ContactUs = () => {
    return (
        <section class="px-4 md:px-16 lg:px-24 xl:px-32 w-full bg-gray-800">
            <p class="text-center font-medium text-pink-600 px-10 py-2 rounded-full bg-pink-950/70 border border-pink-800 w-max mx-auto">Contact</p>
            <h3 class="text-3xl font-semibold text-white text-center mx-auto mt-4">Reach out to us</h3>
            <p class="text-slate-300 text-center mt-2 max-w-md mx-auto">Ready to grow your brand? Let’s connect and build something exceptional together.</p>

            <form class="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl mx-auto text-slate-300 mt-16 w-full">
                <div>
                    <p class="mb-2 font-medium">Your name</p>
                    <div class="flex items-center pl-3 rounded-lg overflow-hidden border border-slate-700 focus-within:border-pink-500">
                        ...
                        <input placeholder="Enter your name" class="w-full p-3 bg-transparent outline-none" type="text" name="name" />
                    </div>
                </div>
                <div>
                    ...
                    <div class="flex items-center pl-3 rounded-lg overflow-hidden border border-slate-700 focus-within:border-pink-500">
                        ...
                        <input placeholder="Enter your email" class="w-full p-3 bg-transparent outline-none" type="email" name="email" />
                    </div>
                </div>
